...
public class ConnectorMysqlCdcEntryController {

    private final ConnectorMysqlCdcService service;

    public ConnectorMysqlCdcEntryController(ConnectorMysqlCdcService service) {
