package cn.javahome.frank.cdp.connector.kafka.controller;
 ...
 */
@RestController
@RequestMapping("/connector/kafka")
public class ConnectorKafkaEntryController {

    private final ConnectorKafkaService service;

    public ConnectorKafkaEntryController(ConnectorKafkaService service) {
