...
public class ConnectorControlEntryController {

    private final ConnectorControlService service;

    public ConnectorControlEntryController(ConnectorControlService service) {
