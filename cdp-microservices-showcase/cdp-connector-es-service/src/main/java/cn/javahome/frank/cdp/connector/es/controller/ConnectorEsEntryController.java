package cn.javahome.frank.cdp.connector.es.controller;
 ...
 */
@RestController
@RequestMapping("/connector/es")
public class ConnectorEsEntryController {

    private final ConnectorEsService service;

    public ConnectorEsEntryController(ConnectorEsService service) {
